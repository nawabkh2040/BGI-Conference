...
SECRET_KEY = 'django-insecure-ed!+dt#f6m=$(uf@&ds%=zbv_3v$f*lg3^ynwpfn4&l##!m-8&'
...
CSRF_TRUSTED_ORIGINS = ['http://192.168.255.194','http://127.0.0.1']
...
from conference.mail_key import key
